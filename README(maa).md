...
## 明日方舟伤害计算公式
$$
Damage=(ATK*Rate_1-(1-Rate_2)*DEF_{enemy})*Rate_{3,1}*Rate_{3,2}*Rate_{3,...}
$$

**其中：**

* $ATK$为干员面板攻击力，$DEF_{enemy}$为敌人防御力。
* $Rate_1$表示由干员天赋/技能等带来的攻击力倍率加成
* $Rate_2$表示敌方所受的百分比防御削减debuff
* $Rate_{3,i}$表示其余效果产生的独立乘区，如敌人具有的百分比减伤效果，干员具有的物理/法术伤害百分比加成效果等。
